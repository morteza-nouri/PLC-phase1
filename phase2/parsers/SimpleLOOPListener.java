...
public interface SimpleLOOPListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SimpleLOOPParser#voidType}.
	 * @param ctx the parse tree
	 */
	void enterVoidType(SimpleLOOPParser.VoidTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleLOOPParser#voidType}.
	 * @param ctx the parse tree
	 */
	void exitVoidType(SimpleLOOPParser.VoidTypeContext ctx);
	/**
